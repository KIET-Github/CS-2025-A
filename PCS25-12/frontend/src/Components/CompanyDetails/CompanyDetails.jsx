...
import { getCompanyById } from "../../api/Admin/Admin.api"; 
...
const CompanyDetails = () => {
  ...
  // if (loading) {
  //   return (
  //     <div className="p-4 sm:ml-64 min-h-screen text-blue-200">Loading...</div>
  //   );
  // }

  // if (error) {
  //   return (
  //     <div className="p-4 sm:ml-64 min-h-screen text-blue-200">{error}</div>
  //   );
  // }

  // if (!company) {
  //   return (
  //     <div className="p-4 sm:ml-64 min-h-screen text-blue-200">
  //       Company not found
  //     </div>
  //   );
  // }
        ...
        <div className="flex items-center justify-center w-full min-h-[80vh]">
          <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mt-8 text-center">
              ...
              <button className="inline-flex items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 bg-blue-500 text-gray-50 hover:bg-primary/90 h-10 py-2 px-4 rounded-md">
                Apply Now
              </button>
            </div>
          </div>
